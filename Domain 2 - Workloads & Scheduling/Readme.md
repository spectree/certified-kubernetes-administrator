...
| 14 | [Scheduling Pods without a Scheduler][PlDn] | [PlDr][Find statid pods in node]            | aka static pods. Statics can be installed without k8s controle plane. <br/> It is installed using kubelet agent. <br/> <br/> Place the k8s pod yaml file in /etc/kubernetes/manifests directory <br/> of kubelet node. Kubelet periodcally scan this directory and will create the pod |
